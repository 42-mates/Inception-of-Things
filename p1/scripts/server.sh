...
TOKEN_FILE="/var/lib/rancher/k3s/server/node-token"     # default location of the K3s node token
...
# | sh -s - server:             pipe the installation script to the shell and run it in server mode
# options:
